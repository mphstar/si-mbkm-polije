...
return [
    ...
    */
    ...
    'project_logo'   =>  '<img src="assets/img/simbkm.png" alt="responsive devices" class="custom-image-size">',

    // Show / hide breadcrumbs on admin panel pages.
    'breadcrumbs' => true,

    // Horizontal navbar classes. Helps make the admin panel look similar to your project's design.
    'header_class' => 'app-header bg-transparent border-2 navbar',
    ...
    */
    ...
    'registration_open' => env('BACKPACK_REGISTRATION_OPEN', env('APP_ENV') == 'local' ? true : false),

...
<li class='nav-item'><a class='nav-link' href="{{ backpack_url('lecture') }}"><i class='nav-icon la la-users'></i> Lectures</a></li>
=======
...
<li class='nav-item'><a class='nav-link' href='{{ backpack_url('mbkm') }}'><i class='nav-icon la la-book'></i> Mbkms</a></li>

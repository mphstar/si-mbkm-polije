...
@section('content')
                        ...
                        <table class="table table-striped">
                            <thead>
                                <tr>
                                    ...
                                    <th>
                                        <form
                                            action="{{ route('uprove', ['id' => $result[0]->id, 'approval' => 'approved']) }}"
                                            method="GET">
                                            {{ csrf_field() }}
                                    ...
                                    <th>
                                        ...
                                        <button class="btn btn-primary btn-sm update-status-btn" data-toggle="modal"
                                            data-target="#updateStatusModal" data-partner-id="">Update Status</button>
    ...
    <form action="{{ route('tolak', ['id' => $result[0]->id, 'not_aprroval' => 'Not approved']) }}" method="post">
        ...
        <div class="modal fade" id="updateStatusModal" tabindex="-1" role="dialog"
            aria-labelledby="updateStatusModalLabel" aria-hidden="true" data-backdrop="false">

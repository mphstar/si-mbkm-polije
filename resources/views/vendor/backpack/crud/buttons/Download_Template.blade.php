<a href="{{ route('penilaian-mitra.unduhtemplate', $entry->getKey()) }}"class=""><i class=""></i><svg width="45px" height="45px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">

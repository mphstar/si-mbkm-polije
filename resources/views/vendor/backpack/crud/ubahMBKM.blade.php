                    ...
                    <form action="/admin/management-m-b-k-m/updatembkm"method="post">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control"
                                name="nama_penanggung_jawab"value="{{ $data->nama_penanggung_jawab }}">

                        </div>

                        <div class="form-group">
                            <label>Tanggal Awal Pendaftaran</label>
                            <input type="date" class="form-control"id="start_reg" name="start_reg"
                                value="{{ $data->start_reg }}">

                        </div>
                        <div class="form-group">
                            <label>Tanggal Tarakhir Pendaftaran</label>

                            <input type="date" class="form-control"id="end_reg" name="end_reg"
                                value="{{ $data->end_reg }}">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" name="id_jenis">
                                @foreach ($jenis_mbkm as $key)
                                    <option {{ $key->id == $data->id_jenis ? 'selected' : '' }} value="{{ $key->id }}">{{ $key->jenismbkm }}</option>
                                @endforeach
